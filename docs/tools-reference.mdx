...
description: "Overview of all MCP tools for Jira, Confluence, and Requirements Yogi — organized by category with quick links"
---

MCP Atlassian provides **72 tools** for Jira and Confluence, plus **6 Requirements Yogi tools** (fork extension). Tools are organized by category below.
...
<Note>
Requirements Yogi tools are a fork extension. They require the [Requirements Yogi](https://www.requirementsyogi.com/) app installed in your Confluence instance and reuse Confluence authentication automatically.
</Note>

<CardGroup cols={2}>
  <Card title="Requirements" icon="list-check" href="/docs/tools/requirement-yogi">
    Search, read, create, update, and delete requirements
  </Card>
  <Card title="Search Syntax" icon="magnifying-glass" href="/docs/guides/requirement-yogi-search">
    Requirements Yogi query language reference
  </Card>
</CardGroup>
...
**Requirements Yogi Toolsets (1):**

| Toolset | Core | Tools |
|---------|:----:|-------|
| `requirement_yogi` | No | `requirement_yogi_get_requirement`, `requirement_yogi_list_requirements`, `requirement_yogi_search_requirements`, `requirement_yogi_create_requirement`, `requirement_yogi_update_requirement`, `requirement_yogi_delete_requirement` |
...
# Enable all toolsets including Requirements Yogi (78 tools)
TOOLSETS=all

# Enable Requirements Yogi toolset explicitly
